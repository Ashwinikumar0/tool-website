  ...
  return (
    <Box component={"section"}>
      ...
      >
        ...
        >
          A Text-Reverse Tool is a simple utility that takes input text and
          reverses its characters or words, producing the text in reverse order.
        </Typography>
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Reversed text is commonly used in puzzles or secret codes where readers need to decipher the reversed message."
                }
                primaryTypographyProps={{
                  fontSize: 14,
                  letterSpacing: 0.2,
