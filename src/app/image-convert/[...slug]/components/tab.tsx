...
const Tab = ({ params }) => {
  ...
  const [inputFormat, outputFormat]: [string, string] = paramsData.split(
    "-to-",
  ) as [string, string];

  const handleImageFormatChange = (convertFrom: string, convertTo: string) =>
    router.push(`/image-convert/${convertFrom}-to-${convertTo}`);
  return (
    <>
      <Box
        mt={2}
      ...
      >
        <TabButton
          ...
          handleImageFormatChange={() =>
            handleImageFormatChange("jpeg", "webp")
          }
        ...
        <TabButton
          ...
          handleImageFormatChange={() =>
            handleImageFormatChange("webp", "jpeg")
          }
