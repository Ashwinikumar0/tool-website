...
export const metadata: Metadata = {
  ...
  description:
    " Generate strong, secure passwords effortlessly with our customizable password generator tool. Enhance your online security with ease.",
  keywords: [
    "free password generator free",
    "online password generator free",
    "password generator free online",
    "free password maker",
    "google password maker",
    ...
    "online random password generator free",
