    ...
    <Box component={"section"}>
                ...
                <TableCell align="right">
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={noSimilar}
                        onChange={(e) => setNoSimilar(e.target.checked)}
                      />
                    }
                    label=""
                  />
      ...
      >
        ...
        >
          <Typography
            variant="body1"
            sx={{ wordBreak: "break-all", px: 2, color: "#fff" }}
          >
            {password}
          </Typography>
      ...
      >
        ...
        >
          Creating strong, unique passwords is crucial for protecting your
          online accounts and sensitive information. Our Strong Password
          Generator tool makes it easy to create complex, secure passwords that
          are difficult to crack, ensuring your data remains safe.
        </Typography>
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Choose your password length and the types of characters to include, such as uppercase letters, numbers, and symbols."
                }
                primaryTypographyProps={{
                  fontSize: 14,
                  letterSpacing: 0.2,
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Select the character types you want to include (uppercase letters, numbers, symbols)."
                }
                primaryTypographyProps={{
                  fontSize: 14,
                  letterSpacing: 0.2,
