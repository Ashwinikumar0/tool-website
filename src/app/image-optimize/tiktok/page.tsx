...
export const metadata: Metadata = {
  ...
  keywords: [
    "TikTok Profile Picture Resizer Free",
    "Online Free Resizer",
    `Free TikTok Profile Picture Resizer Resizer`,
    "tiktok profile picture downloader",
    "tiktok profile picture ideas",
    "how to make a good tiktok profile picture",
    "tiktok profile picture downloader online",
  ],
};
