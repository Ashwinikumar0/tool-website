  ...
  return (
    <Box component={"section"}>
      ...
      >
        ...
        >
          A Text-Repeater Tool is a simple yet powerful utility that allows
          users to repeat a given piece of text multiple times, with optional
          delimiters between repetitions. This tool can be useful for a variety
          of purposes, such as generating repeated patterns of text for testing,
          creating repeated content for design mockups, or producing large
          blocks of text quickly.
        </Typography>
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Ensures that the repeated text is identical every time, reducing human error."
                }
                primaryTypographyProps={{
                  fontSize: 14,
                  letterSpacing: 0.2,
