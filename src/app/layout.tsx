...
export const metadata: Metadata = {
  ...
  // },
  description:
    "Convert Master Free online converter Tools. Upload your file and click Convert. Then you can download your converted file.",
  twitter: {
  ...
  authors: [{ name: "Ashwin", url: "https://github.com/Ashwinikumar0" }],
  openGraph: {
    title: "ConvertMaster",
    description:
      "Convert Master Free online converter Tools. Upload your file and click Convert. Then you can download your converted file.",
    ...
    <html lang={locale}>
      <head>
        <meta
          ...
          content="gcYNBWqBdyY8i1Y1LtL39rmYsmdMMRokCwsPppsJen4"
        />
        <GoogleAnalytics />
        <meta
          name="ded46ff83865378e6701c3070cf87a3a3b75f5ae"
          content="ded46ff83865378e6701c3070cf87a3a3b75f5ae"
        />
        {/* <script>
        (function(xzxp){
          var d = document,
