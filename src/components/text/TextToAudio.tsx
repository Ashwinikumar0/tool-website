...
const TextToAudioConverter = () => {
  ...
  const captureSpeech = async () => {
    ...
    if ("MediaRecorder" in window) {
      try {
        const streamData: MediaStream | null =
  ...
  return (
    <Box sx={{ padding: 4 }}>
      ...
      >
        ...
        >
          Text-to-audio (or text-to-speech) technology converts written text
          into spoken words using computer-generated voices. This technology is
          widely used for various applications, including audiobooks,
          accessibility for visually impaired users, language learning, and
          content creation.
        </Typography>
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Choose the voice, pitch, and speed settings if available."
                }
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
