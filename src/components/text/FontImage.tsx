...
const FontImageConverter = () => {
  ...
  const [backgroundColor, setBackgroundColor] = useState(
    theme.palette.mode === "light" ? "transparent" : "#39ff14",
  );
  const [textShadow, setTextShadow] = useState(
    theme.palette.mode === "light"
      ? "2px 2px 4px rgba(0,0,0,0.5)"
      : "3px 3px 8px rgba(50,205,50,0.5)",
  );
  ...
  return (
    <Box component={"section"}>
            ...
            >
              ...
              <Grid item xs={6} md={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setTextShadow(
                      `${e.target.value}px ${textShadow.split(" ")[1]} ${textShadow.split(" ")[2]} ${textShadow.split(" ")[3]}`,
                    )
                  }
                />
              </Grid>
              <Grid item xs={6} md={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setTextShadow(
                      `${textShadow.split(" ")[0]} ${e.target.value}px ${textShadow.split(" ")[2]} ${textShadow.split(" ")[3]}`,
                    )
                  }
                />
              </Grid>
              <Grid item xs={6} md={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setTextShadow(
                      `${textShadow.split(" ")[0]} ${textShadow.split(" ")[1]} ${e.target.value}px ${textShadow.split(" ")[3]}`,
                    )
                  }
                />
              </Grid>
            ...
            >
              <Grid item xs={6} md={4}>
                <TextField
                  ...
                  onChange={(e) =>
                    setTextShadow(
                      `${textShadow.split(" ")[0]} ${textShadow.split(" ")[1]} ${textShadow.split(" ")[2]} ${e.target.value}`,
                    )
                  }
                  sx={{ width: 150 }}
                />
      ...
      >
        ...
        >
          A Cool Text Font Generator is an online tool that allows users to
          generate custom and stylish fonts that can be used in social media
          posts, websites, digital designs, or any text-based projects. These
          tools often provide a wide variety of fonts, including fancy,
          decorative, artistic, or unusual text styles. These fonts are
          typically based on Unicode characters, which makes them compatible
          with most online platforms, such as Facebook, Instagram, Twitter, and
          others.
        </Typography>
        ...
        <List
          sx={{ width: { xs: "100%" }, p: "10px", bgcolor: "background.paper" }}
        >
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "After generating a custom text in a cool font, you can copy it and paste it into your social media profiles, or websites."
                }
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "The tool will automatically generate a list of cool font styles for the text you entered."
                }
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Browse through the various font options. You'll often see styles like bold, italic, cursive, bubble text, glitchy text, and others."
                }
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
