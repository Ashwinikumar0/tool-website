...
const BoldTextConverter = () => {
  ...
  const handleConversion = () => {
    const convertedText = isItalic
      ? toBoldItalicUnicode(inputText)
      : toBoldUnicode(inputText);
    ...
    <Box component={"section"}>
      ...
      <Box textAlign={"left"} sx={{ px: { xs: 2, md: 0 } }}>
        <Button variant="outlined" component="span" sx={{ my: 1 }}>
          <Switch checked={isItalic} onChange={handleIsItalic} />
      ...
      >
        ...
        >
          Bold Text Generator is a convenient online tool designed to transform
          regular text into bold style using standard Unicode characters.
          Whether you are looking for a bold font generator or simply need to
          convert text to bold format, this tool is ideal for the job. It
          enables you to effortlessly style your text in bold, making it
          suitable for copying and pasting onto any text-based platform. With
          this free online converter, you can quickly enhance the appearance of
          your text, ensuring it stands out wherever you use it.
        </Typography>
      </Box>
    </Box>
  );
