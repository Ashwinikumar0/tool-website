  ...
  return (
    <Box component={"section"}>
      ...
      <Paper elevation={1} sx={{ padding: 2, marginBottom: 2 }}>
        ...
        <Typography>
          Total Characters (with spaces): {countCharacters(text)}
        </Typography>
        <Typography>
          Total Characters (without spaces): {countCharactersNoSpaces(text)}
        </Typography>
        <Typography>Total Sentences: {countSentences(text)}</Typography>
        <Typography>Total Paragraphs: {countParagraphs(text)}</Typography>
        <Typography>
          Average Words per Sentence: {averageWordsPerSentence(text)}
        </Typography>
      ...
      >
        ...
        >
          A Word Counter is a digital tool designed to help users count the
          number of words, characters, sentences, paragraphs, and other
          text-related metrics in a given text. This tool is particularly useful
          for writers, students, editors, and anyone who needs to adhere to
          specific length requirements for their text. A word counter not only
          helps in counting words but also provides detailed insights into the
          text, such as the total number of characters (with and without
          spaces), the number of sentences and paragraphs, average words per
          sentence, and word density. This makes it an invaluable resource for
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "Analyze sentence length and structure to enhance readability and clarity."
                }
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={
                  "The tool will instantly display the total number of words, characters, sentences, paragraphs, average words per sentence, and top 5 word density."
                }
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
