...
const ImageResizer = () => {
  ...
  const handleTargetSizeDropdownChange = (
    event: React.ChangeEvent<HTMLInputElement>,
  ) => {
    setConvertedFile(null);
    setTargetSize(event.target.value as string);
  };
  const handleFormatDropdownChange = (
    event: React.ChangeEvent<HTMLInputElement>,
  ) => {
    setConvertedFile(null);
  ...
  return (
    <Box component={"section"}>
      ...
      <Typography variant="body2" align="center">
        Welcome to our simple and free online image resizer tool. Easily resize
        your images to specific kilobyte sizes for web and mobile use.
      </Typography>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        >
          An image resizer to kilobytes converter allows you to reduce the file
          size of your images to a specific number of kilobytes. This is
          particularly useful for meeting size limits on websites, reducing load
          times, and saving storage space.
        </Typography>
