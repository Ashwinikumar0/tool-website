...
const OptimizeCom = () => {
          ...
          canvas.toBlob(
            (blob) => {
              resolve(
                new File(
                  [blob],
                  selectedFile.name.replace(/\.\w+$/, `.${format}`),
                  { type: `image/${format}` },
                ),
              );
            },
  ...
  // console.log("conveterd Image: ", convertedFile);

  return (
    <Box component={"section"}>
      <Typography variant="h4" component={"h4"} align="center" pt={2}>
        Image Optimizer
      </Typography>
      <Box
        sx={{
      ...
      >
        ...
        >
          ...
          <Typography>Valid Formats: .jpeg, .png, .webp</Typography>
        </Box>
        <Box
          sx={{
            display: "flex",
        ...
        >
          ...
          <Grid container justifyContent={"center"}>
            ...
            <Grid item xs={2} margin={"5px auto"}></Grid>
          </Grid>
        </Box>
      </Box>
      ...
      <Box sx={{ pt: 5, margin: "auto" }}>
        <Typography component={"h4"} variant="h6" color={"primary"}>
          Effortlessly Convert Your Images with Our Online Image Resizer and
          Optimizer
        </Typography>
        <Typography
          variant="caption"
        ...
        >
          Transform your images in just a few clicks with our user-friendly
          Image Resizer.
        </Typography>
        ...
        >
          ...
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemText
                inset
                primary={`Users can specify the width and height to resize the image. Users can set the image quality for compression. Users can convert the image to a different format (JPEG, PNG, WEBP).`}
                primaryTypographyProps={{
                  fontSize: 10,
                  letterSpacing: 0.2,
                }}
