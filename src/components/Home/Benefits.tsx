  ...
  return (
    ...
    >
      <Container>
        ...
        >
          We provides precise and accurate text conversion and images resizer,
          ensuring high-quality results even for complex documents. The
          user-friendly interface allows for easy conversion with minimal
          clicks, making it accessible to everyone regardless of technical
          skill. Our tool supports various image formats, including JPG, PNG,
          and WEBP. Users can expect fast processing speeds, maintaining high
          quality without delays, which is ideal for time-sensitive tasks. We
          prioritize user privacy and security, ensuring that all files are
          processed securely and no data is stored on our servers.
        </Typography>
        <ListContainer
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
